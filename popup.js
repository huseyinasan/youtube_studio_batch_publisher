document.getElementById("runScript").addEventListener("click", async () => {
    // Get the chosen visibility from the dropdown.
    const selectedVisibility = document.getElementById("visibilitySelect").value;
    console.log("Selected visibility:", selectedVisibility);
  
    // Define your automation code as a function that accepts the visibility setting.
    function automationCode(visibilitySetting) {
      console.log("Automation code injected with visibility:", visibilitySetting);
      ...
      // Use the injected value instead of hard-coding.
      const VISIBILITY = visibilitySetting; // 'Public' / 'Private' / 'Unlisted'
      // -----------------------------------------------------------------
      ...
      // Art by Joan G. Stark (ASCII art omitted for brevity)
    ...
    // Query the active tab and inject the automationCode function with the selected visibility.
    try {
      ...
      if (tab && tab.id) {
        chrome.scripting.executeScript(
          ...
          () => {
            console.log(
              "Automation script injected with visibility:",
              selectedVisibility
            );
          }
        );
